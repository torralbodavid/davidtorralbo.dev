...
@section('description', 'My name is David Torralbo, I\'m a '.\Carbon\Carbon::parse('1997-10-30')->age.' years old Backend Developer from Banyoles, Girona. I work at GNA Hotel Solutions since 2017.')
    ...
    <div class="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
        <div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
            ...
            <p class="mt-3 max-w-md mx-auto text-lg text-gray-200 sm:text-xl md:mt-5 md:max-w-3xl">
                ...
                I'm a {{ \Carbon\Carbon::parse('1997-10-30')->age }} years old Backend Developer from Banyoles, Girona. I work at
    ...
    <div class="relative max-w-screen-xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div class="md:ml-auto md:w-1/2 md:pl-10">
            ...
            <p class="mt-3 text-lg leading-7 text-gray-200">
                If you have any question, doubt or you think I can help you with something you worry about, feel free to contact me through the form you will see when clicking the button below. I will write to you
                as soon as I can! 😇
            </p>
            <div class="mt-8">
